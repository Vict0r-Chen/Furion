# 由于发现个别企业将 `Furion v5` 未正式发布的代码包含在商业项目中且删除了 `Furion` 的 `License` 说明，故将 `v5` 版本代码临时设置为私有仓库研发，直至完成再发布。

# 开源不易，MIT 开源更不易，请！且行且珍惜。
...
| [Furion.DependencyInjection.Hosting](https://gitee.com/dotnetchina/Furion/tree/v5-dev/framework/Furion.DependencyInjection.Hosting)           | ✅   | ✅       | [![nuget](https://img.shields.io/nuget/v/Furion.DependencyInjection.Hosting.svg?cacheSeconds=10800)](https://www.nuget.org/packages/Furion.DependencyInjection.Hosting)           | ⚠️   |
...
| [Furion.Validation.Fluent](https://gitee.com/dotnetchina/Furion/tree/v5-dev/framework/Furion.Validation.Fluent)                               | ✅   | ✅       | [![nuget](https://img.shields.io/nuget/v/Furion.Validation.Fluent.svg?cacheSeconds=10800)](https://www.nuget.org/packages/Furion.Validation.Fluent)                               | ⚠️   |
| [Furion.Exception](https://gitee.com/dotnetchina/Furion/tree/v5-dev/framework/Furion.Exception)                                               | ✅   | ✅       | [![nuget](https://img.shields.io/nuget/v/Furion.Exception.svg?cacheSeconds=10800)](https://www.nuget.org/packages/Furion.Exception)                                               | ⚠️   |
| [Furion.Exception.AspNetCore](https://gitee.com/dotnetchina/Furion/tree/v5-dev/framework/Furion.Exception.AspNetCore)                         | ✅   | ✅       | [![nuget](https://img.shields.io/nuget/v/Furion.Exception.AspNetCore.svg?cacheSeconds=10800)](https://www.nuget.org/packages/Furion.Exception.AspNetCore)                         | ⚠️   |
| [Furion.Exception.Policy](https://gitee.com/dotnetchina/Furion/tree/v5-dev/framework/Furion.Exception.Policy)                                 | ✅   | ✅       | [![nuget](https://img.shields.io/nuget/v/Furion.Exception.Policy.svg?cacheSeconds=10800)](https://www.nuget.org/packages/Furion.Exception.Policy)                                 | ⚠️   |
| [Furion.Kit](https://gitee.com/dotnetchina/Furion/tree/v5-dev/framework/Furion.Kit)                                                           | ✅   | ✅       | [![nuget](https://img.shields.io/nuget/v/Furion.Kit.svg?cacheSeconds=10800)](https://www.nuget.org/packages/Kit)                                                                  | ⚠️   |
| [Furion.OpenApi](https://gitee.com/dotnetchina/Furion/tree/v5-dev/framework/Furion.OpenApi)                                                   | ⏳   | ⏳       |                                                                                                                                                                                   | ⚠️   |
| [Furion.Logging](https://gitee.com/dotnetchina/Furion/tree/v5-dev/framework/Furion.Logging)                                                   | ⏳   | ⏳       |                                                                                                                                                                                   | ⚠️   |
