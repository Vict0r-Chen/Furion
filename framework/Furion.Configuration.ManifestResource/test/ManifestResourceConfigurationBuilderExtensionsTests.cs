...
{
    [Fact]
    public void AddManifestResource_Null_Throw()
    {
    ...
    [Fact]
    public void AddManifestResource_Parameterless_ReturnOK()
    {
        var configurationBuilder = new ConfigurationBuilder();
    ...
    [Fact]
    public void AddManifestResource_ActionConfigure()
    {
        var configurationBuilder = new ConfigurationBuilder();
    ...
    [Fact]
    public void AddManifestResource_Instance()
    {
        var configurationBuilder = new ConfigurationBuilder();
        ...
        Assert.Equal("Furion - Embed", configuration.GetValue<string>("Furion.Configuration.ManifestResource.Tests:Name"));
    }
}