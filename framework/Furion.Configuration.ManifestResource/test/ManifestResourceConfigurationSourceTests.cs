...
public class ManifestResourceConfigurationSourceTests
{
    ...
    public void New_Invalid_Parameters()
    {
        ...
        {
            var manifestResourceConfigurationSource = new ManifestResourceConfigurationSource(null!, null!);
        });
    ...
    public void New_ReturnOK()
    {
        ...
        Assert.Empty(manifestResourceConfigurationSource._manifestResourceConfigurationModels);
        Assert.NotNull(manifestResourceConfigurationSource._manifestResourceConfigurationParser);
    }
