...
public class ServiceInjectionAttributeTests
{
    ...
    public void NewInstance_With_Parameterless_ReturnOK()
    {
        ...
        Assert.False(serviceInjectionAttribute.Ignore);
        Assert.Equal(0, serviceInjectionAttribute.Order);
        Assert.False(serviceInjectionAttribute.IncludeSelf);
        Assert.False(serviceInjectionAttribute.IncludeBase);
    }
    ...
    public void AttributeUsage_Attribute_Check()
    {
        ...
        Assert.Equal(AttributeTargets.Class, serviceInjectionAttribute.ValidOn);
        Assert.False(serviceInjectionAttribute.AllowMultiple);
        Assert.True(serviceInjectionAttribute.Inherited);
    }
}