...
public class DependencyAttributeTests
{
    ...
    public void NewInstance_With_Parameterless_ReturnOK()
    {
        ...
        Assert.Equal(ServiceAddition.Default, dependencyAttribute.Addition);
        ...
        Assert.False(dependencyAttribute.IncludeBase);
    }
    ...
    {
        var dependencyAttribute = typeof(DependencyAttribute).GetCustomAttribute<AttributeUsageAttribute>();
        Assert.NotNull(dependencyAttribute);
        Assert.Equal(AttributeTargets.Class, dependencyAttribute.ValidOn);
        Assert.False(dependencyAttribute.AllowMultiple);
        Assert.True(dependencyAttribute.Inherited);
    }
}