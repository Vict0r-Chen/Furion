...
public class DependencyInjectionServiceCollectionExtensionsTests
{
    [Fact]
    public void AddDependencyInjection_Null_Throw()
    {
    ...
    [Fact]
    public void AddDependencyInjection_Instance()
    {
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddDependencyInjection_Duplicate()
    {
        var services = new ServiceCollection();
        var dependencyInjectionBuilder = new DependencyInjectionBuilder
        {
