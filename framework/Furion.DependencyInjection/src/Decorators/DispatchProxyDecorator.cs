...
public abstract class DispatchProxyDecorator : DispatchProxy
{
    ...
    /// </summary>
    private static readonly MethodInfo? _invokeAsyncOfTMethod = typeof(DispatchProxyDecorator).GetMethod(nameof(InvokeAsync), 1, BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly, null, new[] { typeof(Invocation) }, null);
}