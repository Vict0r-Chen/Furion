...
public class ArgumentExceptionHelperTests
{
    ...
    public void Throw_ReturnOK()
    {
        ...
        {
            ArgumentExceptionHelper.Throw("furion");
        });
    ...
    [Fact]
    public void ThrowNullOrWhiteSpaceException_ReturnOK()
    {
        var excetpion = Assert.Throws<UserFriendlyException>(() =>
        {
            ArgumentExceptionHelper.ThrowNullOrWhiteSpaceException(null!, "furion");
        });
        ...
        {
            ArgumentExceptionHelper.ThrowNullOrWhiteSpaceException("  ", "furion");
        });
    ...
    [Fact]
    public void ThrowNullOrEmptyException_ReturnOK()
    {
        var excetpion = Assert.Throws<UserFriendlyException>(() =>
        {
            ArgumentExceptionHelper.ThrowNullOrEmptyException(null!, "furion");
        });
        ...
        var excetpion1 = Assert.Throws<UserFriendlyException>(() =>
        {
            ArgumentExceptionHelper.ThrowNullOrEmptyException(string.Empty, "furion");
        });
    ...
    [Fact]
    public void ThrowNullOrEmptyException_Collection_ReturnOK()
    {
        var excetpion = Assert.Throws<UserFriendlyException>(() =>
        {
            ArgumentExceptionHelper.ThrowNullOrEmptyException((ICollection<string>)null!, "furion");
        });
        ...
        var excetpion1 = Assert.Throws<UserFriendlyException>(() =>
        {
            ArgumentExceptionHelper.ThrowNullOrEmptyException(Array.Empty<string>(), "furion");
        });
