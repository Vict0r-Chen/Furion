...
internal static class Helpers
{
    ...
    /// 规则集分隔符
    /// </summary>
    internal static readonly char[] RuleSetSeparator = [',', ';'];
    ...
    internal static void EnsureLegalValidatorType([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type validatorType)
    {
        // 空检查
