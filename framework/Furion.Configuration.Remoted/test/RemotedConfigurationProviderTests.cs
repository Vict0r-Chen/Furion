...
public class RemotedConfigurationProviderTests
{
    [Fact]
    public void New_Invalid_Parameters()
    {
        ...
        {
            var remotedConfigurationProvider = new RemotedConfigurationProvider(null!, null!);
        });
    ...
    public void New_ReturnOK()
    {
        ...
        Assert.Empty(remotedConfigurationProvider._remotedConfigurationModels);
        Assert.NotNull(remotedConfigurationProvider._remotedConfigurationParser);
    }
