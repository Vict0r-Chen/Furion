...
public class LessThanValidatorTests
{
    ...
    public void New_Invalid_Parameters()
    {
        ...
        {
            var validator = new LessThanValidator(null!);
        });
    }
    ...
    public void New_Default()
    {
        ...
        var validator3 = new LessThanValidator("30");
        Assert.Equal("30", validator3.CompareValue);

        var validator4 = new LessThanValidator(() => 30);
    ...
    [Theory]
    [InlineData(typeof(LessThanValidator), true)]
