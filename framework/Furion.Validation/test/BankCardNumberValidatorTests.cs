...
public class BankCardNumberValidatorTests
{
    [Fact]
    ...
    [InlineData(1234567899, true)]
    [InlineData(6234567890, true)]
    [InlineData(6222026006705354000, true)]
    [InlineData("0", false)]
    [InlineData("100", false)]
    [InlineData("123456789", false)]
    [InlineData("1234567890", true)]
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        var validationResultsOfSucceed = validator.GetValidationResults(6222026006705354000, "data");
        Assert.Null(validationResultsOfSucceed);

        var validationResultsOfFailure = validator.GetValidationResults(123456789, "data");
        ...
        Assert.Equal("The field data is not a valid bank card number.", validationResultsOfFailure.First().ErrorMessage);
    }
    ...
    public void FormatErrorMessage_ReturnOK()
    {
        ...
        Assert.Equal("The field data is not a valid bank card number.", validator.FormatErrorMessage("data"));
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        validator.Validate(6222026006705354000, "data");
    }
    ...
    public void Validate_Failure()
    {
        ...
        {
            validator.Validate(123456789, "data");
        });

        Assert.Single(exception.InnerExceptions);
        Assert.Equal("The field data is not a valid bank card number.", exception.InnerExceptions.First().Message);
    }

    [Theory]
    [InlineData(typeof(BankCardNumberValidator), true)]
