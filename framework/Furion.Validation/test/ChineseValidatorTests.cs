...
public class ChineseValidatorTests
{
    ...
    public void New_ReturnOK()
    {
        ...
        Assert.Equal("The field {0} is not a valid Chinese.", validator._errorMessageResourceAccessor());
    }
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        var validationResultsOfFailure = validator.GetValidationResults("C#", "data");
        ...
        Assert.Equal("The field data is not a valid Chinese.", validationResultsOfFailure.First().ErrorMessage);
    }
    ...
    public void FormatErrorMessage_ReturnOK()
    {
        ...
        Assert.Equal("The field data is not a valid Chinese.", validator.FormatErrorMessage("data"));
    }
    ...
    public void Validate_Failure()
    {
        ...
        {
            validator.Validate("C#", "data");
        });

        Assert.Single(exception.InnerExceptions);
        Assert.Equal("The field data is not a valid Chinese.", exception.InnerExceptions.First().Message);
    }

    [Theory]
    [InlineData(typeof(ChineseValidator), true)]
