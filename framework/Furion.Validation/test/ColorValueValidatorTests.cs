...
public class ColorValueValidatorTests
{
    ...
    public void FullMode_IsValid(object? value, bool result)
    {
    ...
    [InlineData("#ff", false)]
    [InlineData("#fffffff", false)]
    public void Standard_IsValid(object? value, bool result)
    {
        var validator = new ColorValueValidator(fullMode: false);
        Assert.Equal(result, validator.IsValid(value));
    }
