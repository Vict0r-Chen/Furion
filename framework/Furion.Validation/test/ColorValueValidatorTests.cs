...
public class ColorValueValidatorTests
{
    ...
    public void New_Default()
    {
        ...
        Assert.True(validator.FullMode);
    ...
    [InlineData("#ff", false)]
    [InlineData("#fffffff", false)]
    public void IsValid_FullModel_False_ReturnOK(object? value, bool result)
    {
        var validator = new ColorValueValidator
        {
            FullMode = false
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        var validationResultsOfSucceed = validator.GetValidationResults("#ffffff", "data");
        Assert.Null(validationResultsOfSucceed);

        var validationResultsOfFailure = validator.GetValidationResults("#fffff", "data");
        ...
        Assert.Equal("The field data is not a valid color value.", validationResultsOfFailure.First().ErrorMessage);
    }
    ...
    public void FormatErrorMessage_ReturnOK()
    {
        ...
        Assert.Equal("The field data is not a valid color value.", validator.FormatErrorMessage("data"));
    }
    ...
    public void Validate_Failure()
    {
        ...
        {
            validator.Validate("#fffff", "data");
        });

        Assert.Single(exception.InnerExceptions);
        Assert.Equal("The field data is not a valid color value.", exception.InnerExceptions.First().Message);
    }

    [Theory]
    [InlineData(typeof(ColorValueValidator), true)]
