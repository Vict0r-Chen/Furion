...
public class ComponentHostApplicationBuilderExtensionsTests
{
    ...
    public void AddComponent_Invalid_Parameters()
    {
        ...
        {
            hostApplicationBuilder.AddComponent(null!, (ComponentBuilder)null!);
        });

        Assert.Throws<ArgumentNullException>(() =>
        {
            hostApplicationBuilder.AddComponent(typeof(AComponent), (ComponentBuilder)null!);
        });
    }
    ...
    {
        var hostApplicationBuilder = Host.CreateApplicationBuilder();
        hostApplicationBuilder.AddComponent(typeof(AComponent), new ComponentBuilder());
    ...
    [Fact]
    public void AddComponentAction_ReturnOK()
    {
        var hostApplicationBuilder = Host.CreateApplicationBuilder();
        hostApplicationBuilder.AddComponent(typeof(AComponent), b => { });
    ...
    [Fact]
    public void AddComponentGeneric_ReturnOK()
    {
        var hostApplicationBuilder = Host.CreateApplicationBuilder();
        hostApplicationBuilder.AddComponent<AComponent>(new ComponentBuilder());
    ...
    [Fact]
    public void AddComponentActionGeneric_ReturnOK()
    {
        var hostApplicationBuilder = Host.CreateApplicationBuilder();
        hostApplicationBuilder.AddComponent<AComponent>(b => { });
