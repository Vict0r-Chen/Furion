...
public class HostingComponentHostApplicationBuilderExtensionsTests
{
    ...
    public void EntryGenericAction_ReturnOK()
    {
        ...
        hostApplicationBuilder.Entry<AComponent>(p => { });

        Assert.Contains(hostApplicationBuilder.Services, s => s.ImplementationType == typeof(ComponentReleaser));
    }

    [Fact]
    public void EntryGeneric_Invalid_Parameters()
    {
        var hostApplicationBuilder = Host.CreateApplicationBuilder();

        Assert.Throws<ArgumentNullException>(() =>
        {
            hostApplicationBuilder.Entry<AComponent>((ComponentBuilder)null!);
        });
    }
    ...
    public void EntryGeneric_ReturnOK()
    {
        ...
        hostApplicationBuilder.Entry<AComponent>(new ComponentBuilder());
