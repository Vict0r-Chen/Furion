...
public class ApplicationComponentContextTests
{
    ...
    public void New_Invalid_Parameters()
    {
        ...
        {
            var applicationComponentContext = new ApplicationComponentContext(null!);
        });
    }
    ...
    public void New_ReturnOK()
    {
        ...
        var applicationComponentContext = new ApplicationComponentContext(builder.Build());
        ...
        Assert.NotNull(applicationComponentContext.Services);
