...
public class AspNetCoreComponentWebApplicationExtensionsTests
{
    ...
    public void UseComponent_Invalid_Parameters()
    {
        ...
        {
            webApplication.UseComponent(null!);
        });
        ...
        Assert.Equal("`Furion.Component.AspNetCore.Tests.AComponent` type is not assignable from `Furion.Component.WebComponent`. (Parameter 'componentType')", exception.Message);
    }
    ...
    public void UseComponent()
    {
        ...
        webApplication.UseComponent(typeof(AWebComponent));
    }

    [Fact]
    public void UseComponentGeneric()
    {
        var builder = WebApplication.CreateBuilder();
        builder.Services.AddCoreOptions();
        var webApplication = builder.Build();

        webApplication.UseComponent<AWebComponent>();
    }
